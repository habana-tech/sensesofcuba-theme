  ...
  if($defaultLangPostId != $currentId)
  {
      ...
      $defaultLangPostFields = get_fields($defaultLangPostId);
                        ...
                        if(($image = get_field('new_images')) && is_array($image) && !empty($image))
                            $currentImage = $image;
                        elseif (($image = get_field('image_1'))  && is_array($image) && !empty($image))
                            $currentImage = $image;
                        ...
                        ?>
                            ...
                            <img class="img-responsive" src="<?php echo $currentImage['url']; ?>" style="width: 100%;max-height: 720px" alt="<?php echo $currentImage['alt']; ?>" />
