...
<div id="mySidenav" style="z-index: 1500" class="container sidenav shadow" >
  ...
  <a href="<?php echo $homeUrl; ?>#Jobs" onclick="activeMenuFunction(this)"><?php echoTranslatedString('navJobs'); ?></a>

    <?php if ($eventsQuery->have_posts()):?>
        <a href="<?php echo $homeUrl; ?>#Events" onclick="activeMenuFunction(this)"><?php echoTranslatedString('navEvents'); ?></a>
    <?php endif;?>
